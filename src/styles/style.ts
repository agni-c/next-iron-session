export const button =
	'hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-900 dark:text-white border border-slate-900 dark:border-white px-4 py-2 rounded focus:outline-2 cursor-pointer';
